...
function olsen_light_admin_notice_sample_content() {
	...
	<div class="notice notice-info is-dismissible olsen-light-sample-content-notice">
		<p>
			<?php echo sprintf( __( 'It looks like the theme was just installed. <a href="%s" target="_blank">Download the sample content</a> to get things moving.', 'olsen-light' ),
			...
			$( '.olsen-light-sample-content-notice' ).on( 'click', '.notice-dismiss', function( e ) {
				$.ajax( {
					...
					data: {
						...
						nonce: '<?php echo wp_create_nonce( 'olsen-light-dismiss-sample-content' ); ?>',
						dismissed: true
					},
					dataType: 'text',
