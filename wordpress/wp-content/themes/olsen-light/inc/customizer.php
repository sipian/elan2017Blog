...
function olsen_light_customize_register( $wpc ) {
	...
	$wpc->add_control( new Olsen_Light_Customize_Static_Text_Control( $wpc, 'upgrade_text', array(
		...
		'description' => array(
			...
			'</ul>',
			'<a href="http://www.cssigniter.com/ignite/themes/olsen/" class="customizer-link customizer-upgrade">' . esc_html__( 'Upgrade To Pro', 'olsen-light' ) . '</a>',
			'<a href="http://www.cssigniter.com/docs/olsen-light/" class="customizer-link customizer-documentation">' . esc_html__( 'Documentation', 'olsen-light' ) . '</a>'
		),
	) ) );
